...
export default function App() {
  ...
  const selected = useMemo(
    () => data.find(d => d.question_id === selectedId) || null,
    [data, selectedId]
  )
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-950 to-slate-900 flex flex-col">
      ...
      <main className="mx-auto max-w-5xl px-4 py-12 animate-fade-in flex-1 w-full">
        <div className="flex flex-col md:flex-row gap-3">
          <div className="relative flex-1">
            <input
              className="w-full pl-12 py-4 pr-4 rounded-2xl bg-slate-800/50 border border-cyan-500/20 
            ...
            />
            <svg
              className="w-5 h-5 absolute left-4 top-[1.125rem] text-cyan-400/70"
      ...
      {/* If you want your custom footer section, keep this block and REMOVE <Footer /> below. */}
      <footer className="mt-auto border-t border-cyan-500/10 bg-slate-950/50 backdrop-blur-sm">
        <div className="mx-auto max-w-5xl px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="text-cyan-400/60 text-sm">© {new Date().getFullYear()} ThreadQuest AI. All rights reserved.</div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="group relative">
                  ...
                  <div className="relative bg-slate-900 rounded p-3">
                    <h4 className="text-cyan-300 font-medium">Prof. Dr. Mitali Desai</h4>
                    <p className="text-cyan-400/70 text-sm">Project Mentor</p>
                  </div>
                </div>
      ...
      <DetailDrawer open={!!selected} item={selected} onClose={() => setSelectedId(null)} />
      {/* Remove this if Footer duplicates the custom footer above */}
      <Footer />
    </div>
  )
}
