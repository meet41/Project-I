export default function Footer() {
  return (
    <footer className="mt-auto border-t border-slate-200 dark:border-cyan-500/10 bg-white dark:bg-[#111827] py-16">
      <div className="mx-auto max-w-6xl px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          {/* Left Section */}
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-slate-800 dark:text-cyan-400">About ThreadQuest AI</h3>
          ...
          {/* Right Section */}
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-slate-800 dark:text-cyan-400">Project Team</h3>
            ...
            <div className="relative group">
              ...
              <div className="relative bg-white dark:bg-slate-900/50 backdrop-blur-xl rounded-xl p-4 border border-slate-200 dark:border-cyan-500/20">
                <div className="flex items-center justify-between gap-3">
                  ...
                  <span className="shrink-0 rounded-full px-3 py-1 text-[10px] md:text-xs uppercase tracking-wide border bg-amber-100 text-amber-800 border-amber-300 dark:bg-gradient-to-r dark:from-amber-400/50 dark:to-pink-400/50 dark:text-white/90 dark:border-white/20" title="Project Mentor">Mentor</span>
                </div>
              </div>
            </div>
              ...
              {([
                ...
                <div key={idx} className="relative group">
                  ...
                  <div className="relative bg-white dark:bg-slate-900/50 backdrop-blur-xl rounded-xl p-3 border border-slate-200 dark:border-cyan-500/20">
                    <div className="flex items-center justify-between gap-3">
                      <div className="text-slate-800 dark:text-cyan-300 font-semibold truncate">{m.name} - {m.id}</div>
                      <span
                        className={
                          `shrink-0 rounded-full px-3 py-1 text-[10px] md:text-xs uppercase tracking-wide border ` +
                          (m.role === 'Leader'
                            ? 'bg-amber-100 text-amber-800 border-amber-300 dark:bg-gradient-to-r dark:from-amber-400/50 dark:to-pink-400/50 dark:text-white/90 dark:border-white/20'
                            : 'bg-cyan-100 text-cyan-800 border-cyan-300 dark:bg-gradient-to-r dark:from-cyan-400/40 dark:to-indigo-400/40 dark:text-white/90 dark:border-white/20')
                        }
                        title={m.role}
                      >
                        {m.role}
